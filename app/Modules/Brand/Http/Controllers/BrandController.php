...
class BrandController extends Controller
{
    ...
    public function show()
    {
        ...
        $brands = Brand::join('users', 'users.id', '=', 'brands.userid')->where('status', array('Y'))->orwhere('status', array('N'))->get(['brands.*']);
    ...
    public function Trashshow()
    {
        ...
        $brands = Brand::join('users', 'users.id', '=', 'brands.userid')->where('status', array('T'))->get(['brands.*']);
