            ...
            <div class="container-none flex-index">
                <div class="flexslider">
                    <div id="slider-index" class="slides">
                        <div class="item">
                            <a href="#"><img src="{{ asset('dist/img/343720.jpeg') }}"  alt="magicslider"></a>
                        ...
                        <div class="item">
                            <a href="#"><img src="{{ asset('dist/img/1035733.jpeg') }}" alt="magicslider"></a>
                        ...
                        <!-- <div class="item">
                            <a href="#"> <img src="{{ asset('dist/img/491914.jpg') }}" alt="magicslider"> </a>
                            <div class="bx-caption ">
                                <div class="container">
                                    <div class="text-slide text-slide3">
                                        ...
                                        <h3 class="caption4">
                                        <a href="#" class="btn-shop">Shop Womens</a></h3>

                                        </div> -->
                                        <div class="item">
                            <a href="#"><img src="{{ asset('dist/img/9982620.jpeg') }}" alt="magicslider"></a>
                            <div class="bx-caption ">
                                <div class="container">
                                    <div class="text-slide text-slide2">
                                        <!-- <h3 class="caption1">Mid-Season</h3> -->
